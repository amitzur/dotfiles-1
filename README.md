...
![Terminal.app](https://raw.github.com/amitzur/dotfiles2/master/iterm/nick-terminal.png)
...
```sh
$ git clone https://github.com/amitzur/dotfiles2.git ~/dotfiles
$ cd ~/dotfiles
$ chmod +x setup.sh
$ ./setup.sh
```
...
```sh
sh -c "`curl -fsSL https://raw.github.com/amitzur/dotfiles2/master/remote-setup.sh`"
```

Or, using wget:

```sh
sh -c "`wget -O - --no-check-certificate https://raw.githubusercontent.com/amitzur/dotfiles2/master/remote-setup.sh`"
```
